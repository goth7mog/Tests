              ...
              function formatDate(date) {
                return (
                  ...
                  date.getMinutes()
							...
							let localTime = new Date(this.worldTime);
							return formatDate(localTime);
            }
          },
          orderStatusName: "Прийнята",
          customerPhoneNumber: "380953647534",
          employeeCreateOrderID: {
            employeeCreateLastName: "Алексеев",
            employeeCreateFirstName: "Олег",
            toString() {
              return `${this.employeeCreateLastName} ${this.employeeCreateFirstName}`;
            }
          },
          employeeID: {
            employeeFirstName: "Дмитрий",
            employeeLastName: "Меньшов",
            toString() {
              return `${this.employeeLastName} ${this.employeeFirstName}`;
            }
          },
          vendorName: "АС",
          vehicleModelName: "428 Кабриолет",
          vehicleRegistrationNumber: "AA5345BP",
          itemName: "Автомагнітола - заміна",
          orderDescription: "Тест"
        },
        {
          orderID: "180",
          startTime: {
          ...
          orderStatusName: "Прийнята",
          customerPhoneNumber: "380960547903",
          employeeCreateOrderID: {
            employeeCreateLastName: "Ковалев",
            employeeCreateFirstName: "Александр",
            toString() {
              return `${this.employeeCreateLastName} ${this.employeeCreateFirstName}`;
            }
          },
          ...
          vendorName: "АС",
          vehicleModelName: "428 Кабриолет",
          vehicleRegistrationNumber: "АА5345BP",
          itemName: "Автомагнітола - заміна",
          orderDescription: "Тест"
        },
        {
          ...
          startTime: {
            ...
            toString() {
              ...
              // console.log(new Date(this.worldTime));
              // let tzoffset =
              //   new Date(this.worldTime).getTimezoneOffset() * 60000; //offset in milliseconds
              // let localISOTime = new Date(Date.parse(this.worldTime) - tzoffset)
              //   .toISOString()
              //   .slice(0, -1);
          ...
          orderStatusName: "Прийнята",
          customerPhoneNumber: "380500109845",
          employeeCreateOrderID: {
            employeeCreateLastName: "Притула",
            employeeCreateFirstName: "Дмитрий",
            toString() {
              return `${this.employeeCreateLastName} ${this.employeeCreateFirstName}`;
            }
          },
          ...
          vendorName: "АС",
          vehicleModelName: "428 Кабриолет",
          vehicleRegistrationNumber: "AK2508BP",
          itemName: "Автомагнітола - заміна",
          orderDescription: "Тест"
        }
      ],
